export const cn = {
  ...
  'ui.enableStorytellerNightOrderSheetDesc':
  '生成额外页面显示首夜和其他夜晚提示',
...
export const en = {
  ...
  'ui.enableStorytellerNightOrderSheetDesc':'Generate an additional page with first night and other night reminders',
...
export const es: Partial<Record<keyof typeof cn, string>> = {
  ...
  'ui.enableStorytellerNightOrderSheetDesc':'Genera una página adicional con recordatorios de la primera noche y otras noches',
...
export const de = {
  ...
  'ui.enableStorytellerNightOrderSheet': 'Erzähler-Nachtreihenfolge aktivieren',
  'ui.storytellerNightOrderSheetDesc':'Erzeugt eine zusätzliche Seite mit der Reihenfolge und den Erinnerungen für die erste Nacht und weitere Nächte',
  'ui.category.storytellerNightSheet': 'Erzähler-Nachtreihenfolge',
} as const;